...
let HomePage = class HomePage {
    constructor(dataProvider, SmartAudioProvider, router, navCtrl, modalCtrl, httpProvider) {
        ...
        this.dataProvider.needToSetIsland.subscribe((state) => {
            if (state) {
    ...
    ionViewDidEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.dataProvider.getIslandIndex().index !== null) {
                const index = this.dataProvider.getIslandIndex().index;
                this.dataProvider.setIslandIndex(null);
                this.slides.slideTo(index, 400);
            }
            // // continue tutorial
            // if (this.player.games < 6 || this.player.games == 10) {
            //   this.handleTutorial(this.player.games, 0);
            // }
        });
    }
    playAudio(delay) {
        setTimeout(() => {
            this.SmartAudioProvider.homeMusic();
        }, delay);
    }
    handleTutorial(games, delay) {
    ...
    setTextAndArrowPositionAndShowTutorial(games, id, deltaY, deltaX, delay) {
        ...
        setTimeout(() => {
            this.checkForTutorial(id);
        }, delay);
    }
    checkForTutorial(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const condition = yield this.dataProvider.getFromStorage(id);
            if (!condition) {
    ...
    setIslands(myTrophy) {
        this.countries.sort((a, b) => a.trophy - b.trophy);
        let myIsland = this.countries.find((con) => con.trophy > myTrophy);
        this.countries.map((con, index) => {
            if (con.trophy < myIsland.trophy) {
                ...
                try {
                    ...
                    setTimeout(() => this.setIslands(myTrophy), 1000);
                    return;
                }
            }
    ...
    countryChanged() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.selectedCountry = yield this.slides.getActiveIndex();
    ...
    preCheck() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.countries[yield this.slides.getActiveIndex()].lock) {
    ...
    selectRandomGame(force = false) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const body = { force };
            this.httpProvider.post("/timetrials/random", body, (res) => {
                ...
                this.presentAlert({
                    ...
                    reply: () => {
                        this.selectRandomGame(force);
                    }
                });
            });
            if (!force) {
                const cities = this.countries[yield this.slides.getActiveIndex()].cities;
    ...
    startGame(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.countries[yield this.slides.getActiveIndex()].cities.map((city) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                if (city.id == id) {
                    // set next tutorial
                    if (this.player.games < 4 || this.player.games == 9) {
                        this.handleTutorial(this.player.games + 1, 5000);
                    }
                    const country = this.countries.find((con) => con.trophy > this.player.trophy);
    ...
    goToGifts() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.SmartAudioProvider.play("trophy");
            let modal = yield this.modalCtrl.create({ component: _gifts_gifts__WEBPACK_IMPORTED_MODULE_7__["GiftsPage"] });
            modal.present();
            modal.onDidDismiss().then((payload) => {
                if (payload.data == "myQmarz") {
                    this.goToProfile({ activeTab: 1 });
                }
            });
        });
    }
    goToMap() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.SmartAudioProvider.play("trophy");
            let mapModal = yield this.modalCtrl.create({
                component: _map_map__WEBPACK_IMPORTED_MODULE_6__["MapPage"]
            });
            mapModal.present();
            mapModal.onDidDismiss().then((payload) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                if (payload.data) {
                    let duration = Math.abs((yield this.slides.getActiveIndex()) - payload.data["setIsland"]) * 400;
    ...
    goToLeaderboard() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.SmartAudioProvider.play("trophy");
            const leaderboardModal = yield this.modalCtrl.create({
                component: _leadership_leadership__WEBPACK_IMPORTED_MODULE_8__["LeadershipPage"]
            });
            leaderboardModal.present();
        });
    }
    goToProfile(componentProps = null) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.readyToPlay.ready) {
                return;
            }
            this.SmartAudioProvider.play("trophy");
            let profileModal = yield this.modalCtrl.create({
                component: _profile_profile__WEBPACK_IMPORTED_MODULE_10__["ProfilePage"],
                componentProps: Object.assign({ isForMe: true }, componentProps)
            });
